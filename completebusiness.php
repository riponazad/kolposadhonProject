...
<div class="pageheader jumbotron">
  <div class="container">
    <h3><span id="roundborder">  সম্পন্ন ব্যবসা তালিকা</span></h3>
  </div>	
</div>
  ...
  <div class="container">
    <div class="row">
	  ...
	  <div id="accordion">
	    <div class="card" data-toggle="collapse" data-parent="#accordion" href="#demo">
		  <div class="row">
		    ...
		    <div class="col-sm-9">
			  ...
			  <h3>খরচঃ ১০,০০০ টাকা।</h3>
			  <h3>লাভঃ ৩,০০০ টাকা।</h3>
		...
		<div class="card" data-toggle="collapse" data-parent="#accordion" data-target="#demo2">
		  <div class="row">
		    <div class="col-sm-3">
		      <div>
		        <img src="user-male-icon.png" alt="profile image" class="img-fluid" width="100%">
		...
		<div class="card" data-toggle="collapse" data-parent="#accordion" href="#demo3">
		  <div class="row">
		    <div class="col-sm-3">
		      <div>
		        <img src="user-male-icon.png" alt="profile image" class="img-fluid" width="100%">
		...
		<div class="card" data-toggle="collapse" data-parent="#accordion" data-target="#demo4">
		  <div class="row">
		    <div class="col-sm-3">
		      <div>
		        <img src="user-male-icon.png" alt="profile image" class="img-fluid" width="100%">
		...
		<div class="card" data-toggle="collapse" data-parent="#accordion" data-target="#demo5">
		  <div class="row">
		    <div class="col-sm-3">
		      <div>
		        <img src="user-male-icon.png" alt="profile image" class="img-fluid" width="100%">
