...
if(isset($_POST['amount']) && $_POST['amount']!= NULL && $_POST['duration']!= NULL){
	$amnt = $_POST['amount'];
	$dur = $_POST['duration'];
	$id = $_GET['investor_id'];
	$sql = "UPDATE investors SET amount = '$amnt', duration = '$dur' WHERE investor_id = '$id'";
  ...
  <body>
    ...
    <section id="main">
      <div class="container">
    	...
    	$id = $_GET['investor_id'];
		$sql = "SELECT amount, duration FROM investors WHERE investor_id='$id'";
        $result = $conn->query($sql);
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="?investor_id=<?php echo $id; ?>" method="post">
