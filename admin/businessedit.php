...
if(isset($_POST['amount']) && $_POST['amount']!= NULL && $_POST['duration']!= NULL && $_POST['rate']!= NULL && $_POST['title']!= NULL){
	...
	$sql = "UPDATE businesses SET fund_amount = '$amnt', duration = '$dur', rate = '$rate', description = '$des', catagory = '$cat', title = '$title' WHERE business_id = '$id'";
  ...
  <body>
    ...
    <section id="main">
      <div class="container">
    	...
    	$id = $_GET['business_id'];
		$sql = "SELECT title, catagory, fund_amount, duration, rate, description FROM businesses WHERE business_id='$id'";
        $result = $conn->query($sql);
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="?business_id=<?php echo $id; ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="number" name="amount" class="form-control" value="<?php echo $row['fund_amount']; ?>">
          </div>
          <div class="form-group">
            <label>Duration (Months)</label>
            <input type="number" name="duration" class="form-control" value="<?php echo $row['duration']; ?>">
          </div>
		  <div class="form-group">
            <label>Rate (%)</label>
