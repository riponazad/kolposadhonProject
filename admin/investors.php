...
if (isset($_GET['investorDelete'])) {
    	$id = $_GET['investorDelete'];
		$sql = "DELETE FROM investors WHERE investor_id='$id'";
		  ...
		  <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Investor List</h3>
				<div class = "navbar-right">
			    <a href="addinvestor.php?msg" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add <span class="badge"></span></a>
			  </div>
              </div>
...
$sql = "SELECT investor_id, name, address, amount, duration, email, gender FROM investors NATURAL JOIN users";
$result = $conn->query($sql);
	...
	while($row = $result->fetch_assoc())
		{
				  ...
				  ?>
					    <td><img src="<?php echo $str; ?>" height="30px" width="30px"></td>
                        <td><?php echo $row['name']; ?></td>
                        
                        <td><?php echo $row['amount']; ?></td>
                        <td ><?php echo $row['duration']; ?></td>
                        <td><?php echo $row['address']; ?></td>
                        <td><a class="btn btn-default" href="investoredit.php?investor_id=<?php echo $row['investor_id']?>" >Edit</a> <a class="btn btn-danger" href="?investorDelete=<?php echo $row['investor_id']?>" onclick="return confirm('Are you sure to delete the data!')">Delete</a></td>
                      </tr>
                      <?php
                          }
                        }
